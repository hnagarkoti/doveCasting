...
import FormComponent from './RegisterForms/FormComponent';
  ...
  render(){
    return(
        <div className="text-center register-form">
            ...
            <p className="text-center">The first step? Providing your personal information.</p>
            <section className="cd-horizontal-timeline">
                <div className="timeline">
                    <div className="events-wrapper">
                        <div className="events">
                            <ol>
                                <li><a href="#0" data-date="16/01/2014" className="selected">1</a></li>
                                <li><a href="#0" data-date="28/02/2014">2</a></li>
                                <li><a href="#0" data-date="20/04/2014">3</a></li>
                    ...
                    <ol>
                        {this.state.items.map(function(item, i){
                            return(
                                ...
                                {item.dataDate == '16/01/2014' ? <FormComponent show="form1" />: null}
                                {item.dataDate == '28/02/2014' ? <FormComponent show="form2" />: null}
                                {item.dataDate == '20/04/2014' ? <FormComponent show="form3" />: null}
                                </li>
                            )
